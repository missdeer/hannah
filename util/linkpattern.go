...
var (
	playlistPatterns = map[*regexp.Regexp]string{
		...
		regexp.MustCompile(`^https?:\/\/y\.qq\.com\/n\/r?yqq\/playlist\/(\d+)(\.html)?`):            "qq",
	...
	songPatterns = map[*regexp.Regexp]string{
		...
		regexp.MustCompile(`^https?:\/\/y\.qq\.com/n\/r?yqq\/song(?:Detail)?\/(\w+)(\.html)?`): "qq",
	...
	artistPatterns = map[*regexp.Regexp]string{
		...
		regexp.MustCompile(`^https?:\/\/y\.qq\.com\/n\/r?yqq\/singer\/(\w+)(\.html)?`): "qq",
	...
	albumPatterns = map[*regexp.Regexp]string{
		...
		regexp.MustCompile(`^https?:\/\/y\.qq\.com\/n\/r?yqq\/album(?:Detail)?\/(\w+)(\.html)?`): "qq",
