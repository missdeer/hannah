...
public:
    ...
    {
        return fileName.endsWith(".m3u", Qt::CaseInsensitive) || fileName.endsWith(".m3u8", Qt::CaseInsensitive) ||
               fileName.endsWith(".pls", Qt::CaseInsensitive) || fileName.endsWith(".csv", Qt::CaseInsensitive);
    }
...
protected:
    ...
    TrackFile playlistEntryToTrackFile(const QString &playlistEntry, const QString &basePath = QString());
};
